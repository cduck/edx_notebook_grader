...
kernel_name = 'sandbox-python-kernel'
#kernel_name = 'python3'  # Insecure, not sandboxed
...
# server set up.
c.CourseDirectory.course_id = "nbgrader-qcs"
...
c.CourseDirectory.db_students = [
    dict(id="student", first_name="EdX", last_name="Student"),
]
...
#  Default: ''
c.NotebookClient.kernel_name = kernel_name
...
c.ExecutePreprocessor.kernel_name = kernel_name
...
## 
#  See also: NotebookClient.kernel_name
c.Execute.kernel_name = kernel_name
